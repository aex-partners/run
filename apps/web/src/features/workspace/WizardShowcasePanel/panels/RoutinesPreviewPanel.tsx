          ...
          {!hasData ? (
            ...
            >
              ...
              <div style={{ display: 'flex', gap: 16, marginBottom: 24, justifyContent: 'center' }}>
                {[
                  { icon: <Table size={13} />, value: entities.length, label: t('routinesPreviewPanel.entities') },
                  { icon: <Link2 size={13} />, value: relations.length, label: t('routinesPreviewPanel.relations') },
                  { icon: <FolderOpen size={13} />, value: categorized.size, label: t('routinesPreviewPanel.modules') },
                ].map((stat) => (
                  <div
                    key={stat.label}
                    style={{
                ...
                {relations.length > 0 && (
                  <div style={{ marginTop: 16, paddingTop: 14, borderTop: '1px solid rgba(255,255,255,0.08)' }}>
                    <div style={{ fontSize: 10, fontWeight: 600, color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 8 }}>
                      {t('routinesPreviewPanel.relationships')}
                    </div>
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 4 }}>
                      ...
                      {relations.length > 12 && (
                        <div style={{ padding: '3px 8px', fontSize: 10, color: 'rgba(255,255,255,0.35)' }}>
                          {t('routinesPreviewPanel.more', { count: relations.length - 12 })}
                        </div>
                      )}
                    </div>
                  </div>
