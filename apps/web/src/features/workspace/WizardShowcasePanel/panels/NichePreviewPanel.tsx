    ...
    <div style={{ display: 'flex', height: '100%', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 12px', borderBottom: '1px solid var(--border)' }}>
          <span style={{ fontSize: 12, fontWeight: 600, color: 'var(--text)' }}>{t('nichePreviewPanel.entities')}</span>
        ...
        <div style={{ padding: '6px 8px' }}>
          <div style={{
            ...
            <Search size={10} /> {t('nichePreviewPanel.searchEntities')}
          </div>
        </div>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', padding: '6px 12px', gap: 6, borderBottom: '1px solid var(--border)', background: 'var(--surface)' }}>
          <MiniToolbarBtn active><LayoutGrid size={10} /> {t('database.views.table')}</MiniToolbarBtn>
          <MiniToolbarBtn><Columns3 size={10} /> {t('database.views.kanban')}</MiniToolbarBtn>
          <MiniToolbarBtn><Calendar size={10} /> {t('database.views.calendar')}</MiniToolbarBtn>
          <MiniToolbarBtn><FileText size={10} /> {t('database.views.form')}</MiniToolbarBtn>
          <div style={{ flex: 1 }} />
          <MiniToolbarBtn><Filter size={10} /></MiniToolbarBtn>
          <MiniToolbarBtn><SlidersHorizontal size={10} /> {t('database.columns')}</MiniToolbarBtn>
          <div style={{
            display: 'flex', alignItems: 'center', gap: 3,
        ...
        <div style={{ padding: '6px 12px', display: 'flex', alignItems: 'center', gap: 8 }}>
          <span style={{ fontSize: 12, fontWeight: 600, color: 'var(--text)' }}>
            {config.entities.find(e => e.active)?.name || t('nichePreviewPanel.data')}
          </span>
          <span style={{ fontSize: 10, color: 'var(--text-muted)', background: 'var(--surface-2)', padding: '1px 6px', borderRadius: 8 }}>
            {t('nichePreviewPanel.records', { count: totalRows })}
          </span>
        </div>
        ...
        <div style={{ flex: 1, overflow: 'hidden' }}>
          ...
          <div style={{
            ...
            <Plus size={11} /> {t('nichePreviewPanel.record')}
          </div>
        </div>
      </div>
    </div>
