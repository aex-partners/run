...
import { Plus, Search, X, Trash2, BookOpen } from "lucide-react";
...
// Light bg / readable fg pairs, one per known category.
const CATEGORY_COLORS: Record<string, { bg: string; fg: string }> = {
  "company-info": { bg: "#e0e7ff", fg: "#3730a3" }, // indigo
  client: { bg: "#d1fae5", fg: "#065f46" }, // emerald
  supplier: { bg: "#fef3c7", fg: "#92400e" }, // amber
  product: { bg: "#ede9fe", fg: "#5b21b6" }, // violet
  process: { bg: "#e0f2fe", fg: "#075985" }, // sky
  policy: { bg: "#ffe4e6", fg: "#9f1239" }, // rose
  preference: { bg: "#ccfbf1", fg: "#115e59" }, // teal
};

// Fallback palette for arbitrary categories, picked deterministically by hash.
            ...
            return (
              <button
                ...
                style={{
                  padding: "4px 12px",
                  borderRadius: 14,
                  border: `1px solid ${active ? c.fg : c.bg}`,
        ...
        <div style={{ flex: 1, overflow: "auto", padding: "0 24px 24px" }}>
          ...
          {!isSearching && entries.length === 0 && (
            <EmptyState
              ...
              description={t("knowledge.noEntriesDescription", { defaultValue: "Cadastre informações da empresa, clientes ou produtos para o agente consultar." })}
            />
          )}
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 6, flexShrink: 0 }}>
                    ...
                    <span
                      style={{
                        padding: "2px 8px",
                        borderRadius: 10,
                        background: categoryColor(entry.category).bg,
                        color: categoryColor(entry.category).fg,
                        fontSize: 11,
                        fontWeight: 500,
                      }}
                    >
