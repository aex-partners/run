...
export function VoiceMode({
  ...
  }, [stopBargeInMonitor, startRecordingWithStream])
  ...
  const stateLabel =
    phase === 'recording' ? t('voiceMode.listening')
    : phase === 'transcribing' ? t('voiceMode.transcribing')
    : phase === 'waiting' ? t('voiceMode.thinking', { agentName })
    : phase === 'speaking' ? t('voiceMode.speaking', { agentName })
    : t('voiceMode.tapToStart')
