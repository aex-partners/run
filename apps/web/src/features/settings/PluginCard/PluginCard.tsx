  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
        ...
        {rating !== undefined && (
          <div style={{ display: 'flex', alignItems: 'center', gap: 3 }}>
            <span aria-label={t('pluginCard.ratingStars', { rating })} style={{ display: 'flex', alignItems: 'center', gap: 3 }}>
        ...
        {installing ? null : installed ? (
          <>
            {onToggle && (
              <label
                style={{ position: 'relative', display: 'inline-block', width: 32, height: 18, flexShrink: 0, cursor: 'pointer' }}
              >
                <input
                  type="checkbox"
                  checked={enabled}
