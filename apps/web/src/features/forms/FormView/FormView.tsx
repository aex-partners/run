...
import { FormSidebar, type FormItem } from '../FormSidebar/FormSidebar'
import { FormBuilder, type FormSettings } from '../../database/FormBuilder/FormBuilder'
import type { FormFieldItem, EntityFieldInfo } from '../../database/FormBuilder/SortableFieldItem'
...
export function FormView({ entityId, entityFields }: FormViewProps) {
  ...
  const handleNewForm = useCallback(() => {
    createForm.mutate({ entityId, name: t('database.forms.newForm') })
  }, [entityId, createForm, t])
      ...
      {activeForm ? (
        ...
        <div style={{
          ...
          {formItems.length === 0
            ...
            : t('database.forms.selectFormToEdit')}
        </div>
      )}
    </div>
  )
