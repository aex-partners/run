  ...
  return (
    ...
    >
      ...
      <input
        ...
        aria-label={t('mailItem.selectEmailFrom', { from })}
      ...
      <button
        ...
        aria-label={starred ? t('mailItem.unstar') : t('mailItem.star')}
      ...
      {/* Content */}
      <div onClick={() => onClick?.(id)} style={{ position: 'relative', flex: 1, minWidth: 0, overflow: 'hidden' }}>
        {/* Row 1: sender + labels + timestamp */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 2 }}>
          <span title={from} style={{
            fontSize: 14,
