...
export const COLUMN_TYPE_REGISTRY: Record<GridColumnType, ColumnTypeMeta> = {
  ...
  status: { defaultWidth: 130, editable: false, supportsAggregation: false, supportedAggregations: ['count'] },
  ...
  priority: { defaultWidth: 120, editable: false, supportsAggregation: false, supportedAggregations: ['count'] },
  ...
  relationship: { defaultWidth: 160, editable: false, supportsAggregation: false, supportedAggregations: ['count'] },
  ai: { defaultWidth: 200, editable: false, supportsAggregation: false, supportedAggregations: ['count'] },
}
