import { Cond, RecordRow, RecordStore } from '@/contexts/manufacturing/application/ports/out/RecordStore'
...
// concrete data in-ports injected by main/wiring/manufacturing.ts satisfy these
// shapes structurally.
