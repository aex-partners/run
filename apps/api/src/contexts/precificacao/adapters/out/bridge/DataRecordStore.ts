...
import { ResolveOwner } from '@/contexts/precificacao/application/ports/out/ResolveOwner'
...
// concrete data in-ports injected by main/wiring/precificacao.ts satisfy these
// shapes structurally.
...
// ACL bridge: precificacao RecordStore -> data ListEntities/QueryRecords/GetRecord/
