import { Cond, RecordRow, RecordStore } from '@/contexts/estoque/application/ports/out/RecordStore'
import { ResolveOwner } from '@/contexts/estoque/application/ports/out/ResolveOwner'
...
// concrete data in-ports injected by main/wiring/estoque.ts satisfy these
// shapes structurally.
...
// ACL bridge: estoque RecordStore -> data ListEntities/QueryRecords/GetRecord/
