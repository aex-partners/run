// Business-process skill templates. Each maps to a category of routines selectable
// in the setup wizard; when a user selects routines, the matching category skills
// are auto-linked to Eric. Ported 1:1 from skill-templates.ts. Pure data + a pure
// selection rule (`getSkillsForRoutines`).
