...
// Teto do query engine do data (`Math.min(limit ?? 50, 500)`): sem limite explícito o histórico
// seria cortado nas 50 linhas mais recentes, perdendo os snapshots MAIS ANTIGOS em silêncio.
const LIMITE = 500
