import { z } from 'zod';
import { OnStartContext, TestOrRunHookContext, TriggerHookContext } from '../context/index.js';
import { TriggerBase } from '../piece-metadata.js';
import { InputPropertyMap } from '../property/index.js';
import { ExtractPieceAuthPropertyTypeForMethods, PieceAuthProperty } from '../property/authentication/index.js';
import { isNil, TriggerStrategy, TriggerTestStrategy, WebhookHandshakeConfiguration, WebhookHandshakeStrategy } from '../compat/shared-types.js';
